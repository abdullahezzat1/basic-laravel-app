      ...
      <table class="timetable_sub">
        ...
        <tbody>
          <tr class="rem1">
            ...
            <td class="invert-image"><a href="single"><img src="images/1.png" alt=" " class="img-responsive"></a></td>
            <td class="invert">
              <div class="quantity">
          ...
          <tr class="rem2">
            ...
            <td class="invert-image"><a href="single"><img src="images/3.png" alt=" " class="img-responsive"></a></td>
            <td class="invert">
              <div class="quantity">
                <div class="quantity-select">
                  <div class="entry value-minus">&nbsp;</div>
